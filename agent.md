...
**Посилання:** на знаю, як зробити, та публікування в Teams потребує дані, які я не дуже розумію
...
- Студентський план Microsoft Azure має якісь скриті обмеження, та через це я не зміг повністю розібратися та використати інструменти для нашого агента.  <img width="596" height="351" alt="image" src="https://github.com/user-attachments/assets/a2d952d6-3d1c-434b-8c64-b8aa0f291f98" />
